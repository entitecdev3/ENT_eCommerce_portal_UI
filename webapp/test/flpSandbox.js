		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#TimeSheetManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TimeSheetManagement-display": {
								"semanticObject": "TimeSheetManagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ent.ui.ecommerce",
									"url": sap.ui.require.toUrl("ent/ui/ecommerce")
								}
							}
						}
					}
